...
def main():
    sender, date, email_body, current_response, conversation_history, attachments_as_text = simple_extract_msg_content("Email\RE New booking 40_ reefer Rizari GR - Singapore  ORMX230121  ARIAN REF 233533.msg")
